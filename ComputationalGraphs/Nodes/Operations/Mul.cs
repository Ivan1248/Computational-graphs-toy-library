...
{
    public class Mul : ParameterlessNode
    {
        private readonly Node a, b;

        public Mul(Node a, Node b, string name = null) : base(new[] { a, b }, a.Dimension, name)
        {
        ...
        protected override void GetErrorGradient(Vector error, out Vector[] inputErrors) =>
            inputErrors = new[] { b.Output * error, a.Output * error };
    }
}